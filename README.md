...
옹벽류는 현장 진입로가 좁아 25톤 트럭을 못 쓰고 5톤단축·5톤장축 트럭으로만 배차하는 경우가 많아, 다른 파트와 별도로 계산합니다.

1. 제품별로 정해진 5톤단축/5톤장축 1대당 최대 적재량(㎡)을 기준으로, 두 트럭 종류를 섞어서 입력 물량을 모두 실을 수 있는 모든 조합을 탐색합니다.
2. 조합별 운반비(5톤 요율 × 단축 대수 + 5톤축 요율 × 장축 대수)를 비교해 **총 운반비가 가장 낮은 조합**을 자동으로 선택합니다. 마지막 1대는 꽉 채우지 않아도 됩니다.
3. 섞어 싣기(다른 제품과 함께 계산)는 지원하지 않으며, 옹벽류를 선택하면 자동으로 1개 제품만 입력하도록 제한됩니다.
4. 규사는 옹벽류에 해당 사항이 없어 입력란이 표시되지 않습니다.
